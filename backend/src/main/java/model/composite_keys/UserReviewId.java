...
public class UserReviewId implements Serializable {
    ...
    public UserReviewId(String userId, String movieRef) {
        this.userId = userId;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(userId, that.userId) && Objects.equals(movieRef, that.movieRef);
    }
